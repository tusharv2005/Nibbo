...
describe("integration sync runtime", () => {
  it("syncNibboHooks passes auto-start and the current server port", () => {
    const { runtime, calls } = makeRuntime();

    const result = runtime.syncNibboHooks();
  ...
  it("does not log Pi extension sync when the managed files are already current", () => {
    ...
    piInstall.registerPiExtension = () => ({
      ...
      skipped: false,
      updated: false,
      extensionDir: "C:/Users/Tester/.pi/agent/extensions/nibbo",
    });
