...
(function initSettingsUiCore(root) {
  const sizeApi = root.NibboSettingsSizeSlider || {};
  const {
    SIZE_UI_MIN,
    SIZE_UI_MAX,
    SIZE_TICK_VALUES,
  ...
  const i18nApi = root.NibboSettingsI18n || {};
  ...
  const animMergeApi = root.NibboSettingsAnimOverridesMerge || {};
  ...
  const shortcutApi = root.NibboShortcutActions || {};
  ...
  const COLLAPSED_GROUPS_STORAGE_KEY = "nibbo.settings.collapsedGroups.v1";
