...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      settingsSubtitle: "Configure how Nibbo behaves on your desktop.",
      ...
      telegramApprovalBotTokenHintHtml: "Create a bot with [@BotFather](https://t.me/botfather) using /newbot, then paste the token here. It is stored in the user-data env file, never in nibbo-prefs.json.",
      ...
      telegramApprovalRecipientHintHtml: "Open [@userinfobot](https://t.me/userinfobot) in Telegram and send /start to get your numeric id. Nibbo uses it both as the allowed approver and as the chat to send approval cards. Send /start to your own bot at least once first.",
      ...
      telegramApprovalDirectSendDesc: "When you reply to a Nibbo completion notification, focus the matching local terminal and paste one line. It does not send Enter.",
      ...
      remoteSshSubtitle: "Manage one-click SSH tunnels for remote AI coding sessions. Profiles never store passwords or passphrases — Nibbo relies on your existing ssh-agent / SSH keys.",
      ...
      remoteSshErrNoLocalPort: "Local Nibbo server is not yet running.",
      remoteSshErrUnknownStrikes: "Multiple unrecognized errors in a row — please check the profile and logs.",
      remoteSshProbeLocalUnhealthy: "Tunnel established but local Nibbo server is not healthy.",
      remoteSshProbeUnresponsive: "Tunnel established but Nibbo is not responding. Make sure Nibbo is running.",
      ...
      remoteSshConnectWarnNoDeploy: "Hooks are not deployed yet. Connect alone only builds the SSH tunnel — Nibbo will not react to remote sessions until you click Deploy / Repair Hooks.",
      ...
      doctorPrivacy: "Privacy notice: this report is generated locally. Nibbo does not upload data. User paths and secrets are redacted before copying.",
      ...
      doctorFixConfirmCodex: "Nibbo will set [features].hooks = true in your Codex config. Continue?",
      doctorFixConfirmCodexTitle: "Enable Codex hooks?",
      doctorFixConfirmCodexDetail: "This repair will change your Codex config and set [features].hooks = true. Nibbo will not make that change unless you confirm it here.",
      doctorFixConfirmCodexAction: "Enable and repair",
      doctorFixConfirmCancel: "Cancel",
      doctorRestartButton: "Restart Nibbo",
      doctorRestarting: "Restarting",
      doctorRestartConfirmTitle: "Restart Nibbo?",
      doctorRestartConfirmDetail: "Nibbo will close and reopen. In-flight requests from your AI coding agents will be dropped. The Doctor window will close as part of the restart.",
      ...
      hardwareBuddyQuickCommandsDesc: "Expose local preset buttons that create adapter-owned quick_command events. Nibbo does not paste text or run shell commands.",
      ...
      hardwareBuddyTestErr_internal_error: "Hardware Buddy test failed inside Nibbo.",
      ...
      rowAgentPermissionsDesc: "Turn off to let this agent handle prompts in its own terminal instead of showing a Nibbo bubble.",
      rowCodexPermissionMode: "Codex permission mode",
      rowCodexPermissionModeDesc: "Native keeps Codex AutoReview and terminal prompts in charge. Intercept shows Nibbo Allow/Deny bubbles.",
      ...
      rowSoundDesc: "Play a chime when Nibbo finishes a task or asks for input.",
      rowVolume: "Volume",
      rowVolumeDesc: "Adjust sound effect volume. Disabled when sound effects are off.",
      rowLowPowerIdleMode: "Low power idle",
      rowLowPowerIdleModeDesc: "Pause idle SVG animation after Nibbo has been still for a few seconds; activity resumes animation immediately.",
      ...
      rowSessionCleanupGroupDesc: "How long Nibbo waits before clearing inactive sessions. Mainly affects remote SSH sessions where the terminal isn't visible — raise the limit for long-running remote work, or set Session timeout to 0 to never clear by time.",
      ...
      rowOpenAtLoginDesc: "Start Nibbo automatically when you log in.",
      ...
      claudeHooksDisconnectConfirmDetail: "This removes Nibbo-managed Claude hooks from ~/.claude/settings.json and turns off automatic management. Start with Claude Code will be kept for later re-enable.",
      ...
      rowStartWithClaudeDesc: "Auto-launch Nibbo whenever a Claude Code session starts.",
      ...
      rowHideBubblesDesc: "Hide permission, notification, and update bubbles across Nibbo.",
      rowBubbleFollow: "Bubbles follow Nibbo",
      ...
      updateBubbleDisableConfirmDetail: "You may miss update failures, download-complete messages, and restart prompts. The update flow itself will still run, but Nibbo will not show update bubbles.",
      ...
      rowDisableMiniModeDesc: "Prevent Nibbo from entering mini mode from edge snap or the menu",
      ...
      placeholderDesc: "This panel will land in a future Nibbo release. The plan lives in docs/plans/plan-settings-panel.md.",
      ...
      langJapanese: "日本語",
      themeTitle: "Theme",
      themeSubtitle: "Pick a theme for Nibbo. Cards show built-in + capability badges so you can see tracked/static/mini differences before switching.",
      ...
      themeImportUserThemeZip: "Import Nibbo theme package (.zip)",
      themeImportUserThemeZipHint: "Nibbo theme zip: root or one top-level folder must contain theme.json. Put SVG, GIF, APNG, PNG, WebP, JPG, or JPEG assets in assets/. Use Codex Pet import for Codex Pet packages.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pets refreshed: ${imported} new, ${updated} updated, ${unchanged} unchanged, ${removed} removed${invalid ? `, ${invalid} invalid` : ""}${switched ? "; active theme reset to Nibbo" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `Uninstalled "${name}"${switched ? " and switched back to Nibbo" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `Couldn't uninstall imported pet: ${message}`,
      animMapTitle: "Animation Map",
      animMapSubtitle: "Silence individual interrupt animations. Events still fire — Nibbo just skips the visual and sound for the selected states.",
      ...
      aboutFooter: "Nibbo is open source. Built with care by the community.",
      aboutCleanupButton: "Remove Nibbo integrations…",
      aboutCleanupConfirm: "Remove Nibbo hooks/plugins from local agents and disable all agent integrations in Nibbo? This does not delete agent apps or user configs.",
      ...
      aboutCleanupKiroNote: "Kiro nibbo.json is kept; only hook entries were removed.",
      ...
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — tusharv2005",
      aboutOpenExternalFailed: "Couldn't open the link in your browser.",
    },
    zh: {
      settingsTitle: "设置",
      settingsSubtitle: "配置 Nibbo 在桌面上的行为。",
      sidebarGeneral: "通用",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "去 [@BotFather](https://t.me/botfather) 用 /newbot 创建机器人，把 token 贴到这里。Token 存到 userData env 文件，不会写入 nibbo-prefs.json。",
      ...
      telegramApprovalRecipientHintHtml: "去 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私聊 /start 拿到你的数字 ID。Nibbo 会用它既作为唯一可审批者，也作为接收审批卡的 chat。记得先去你自己的机器人发一条 /start 激活私聊。",
      ...
      telegramApprovalDirectSendDesc: "回复 Nibbo 完成通知时，聚焦对应的本地终端并粘贴单行文本。不会按 Enter。",
      ...
      remoteSshSubtitle: "管理一键 SSH 隧道，让远程 AI 编码会话像本地一样工作。Nibbo 不存任何密码或私钥口令——依赖你已配置的 ssh-agent / SSH 密钥。",
      ...
      remoteSshErrNoLocalPort: "本地 Nibbo 服务尚未启动。",
      remoteSshErrUnknownStrikes: "连续多次未识别错误，请检查配置和日志。",
      remoteSshProbeLocalUnhealthy: "隧道已建立但本地 Nibbo 服务异常。",
      remoteSshProbeUnresponsive: "隧道已建立但 Nibbo 无响应，请确认 Nibbo 在运行。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 文件还没部署。Connect 只建 SSH 隧道，不部署 hook——必须点 Deploy / Repair Hooks 之后 Nibbo 才会响应远端会话。",
      ...
      doctorPrivacy: "隐私说明：诊断报告只在本机生成，Nibbo 不会上传数据。复制前会脱敏用户路径和密钥。",
      ...
      doctorFixConfirmCodex: "Nibbo 会把 Codex 配置里的 [features].hooks 设为 true。继续吗？",
      doctorFixConfirmCodexTitle: "启用 Codex hooks？",
      doctorFixConfirmCodexDetail: "这次修复会修改你的 Codex 配置，把 [features].hooks 设为 true。只有你在这里确认后，Nibbo 才会做这个改动。",
      doctorFixConfirmCodexAction: "启用并修复",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重启 Nibbo",
      doctorRestarting: "重启中",
      doctorRestartConfirmTitle: "重启 Nibbo？",
      doctorRestartConfirmDetail: "Nibbo 会关闭并重新启动。AI coding agent 正在进行的请求会被中断。重启过程中 Doctor 窗口也会一起关闭。",
      ...
      hardwareBuddyQuickCommandsDesc: "显示本地 preset 按钮，只创建由 adapter 处理的 quick_command 事件；Nibbo 不粘贴文本，也不运行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      hardwareBuddyTestErr_internal_error: "Nibbo 内部执行 Hardware Buddy 测试失败。",
      ...
      rowAgentPermissionsDesc: "关闭后让该 agent 在自己的终端里处理提示，不再弹 Nibbo 气泡。",
      rowCodexPermissionMode: "Codex 权限模式",
      rowCodexPermissionModeDesc: "Native 保持 Codex AutoReview 和终端原生提示接管；Intercept 显示 Nibbo 允许/拒绝气泡。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "Nibbo 完成任务或需要输入时播放提示音。",
      rowVolume: "音量",
      rowVolumeDesc: "调整音效音量。关闭音效时不可用。",
      rowLowPowerIdleMode: "低功耗 idle",
      rowLowPowerIdleModeDesc: "Nibbo 静止几秒后暂停 idle SVG 动画；有活动时会立即恢复动画。",
      ...
      rowSessionCleanupGroupDesc: "Nibbo 等待多久才清理不活跃会话。主要影响远程 SSH 会话（看不到终端窗口）——远程长任务可调大；设为 0 则永远不按时间清理。",
      ...
      rowOpenAtLogin: "开机自启",
      rowOpenAtLoginDesc: "登录系统时自动启动 Nibbo。",
      ...
      claudeHooksDisconnectConfirmDetail: "这会从 `~/.claude/settings.json` 移除 Nibbo 管理的 Claude hooks，并关闭自动管理。`随 Claude Code 启动` 的偏好会保留，方便以后重新启用。",
      claudeHooksDisconnectConfirmAction: "断开 hooks",
      claudeHooksDisconnectConfirmKeep: "继续保留",
      rowStartWithClaude: "随 Claude Code 启动",
      rowStartWithClaudeDesc: "Claude Code 会话开始时自动拉起 Nibbo。",
      rowStartWithClaudeDisabledDesc: "需要先开启 Claude hooks 自动管理。关闭期间，端口变化和外部覆盖都不会被自动修补。",
      rowHideBubbles: "隐藏气泡",
      rowHideBubblesDesc: "隐藏 Nibbo 的权限、通知和更新气泡。",
      rowBubbleFollow: "气泡跟随 Nibbo",
      ...
      updateBubbleDisableConfirmDetail: "隐藏后可能错过更新失败原因、下载完成提示和重启安装提示。更新流程本身仍会继续，但 Nibbo 不再显示更新气泡。",
      ...
      placeholderDesc: "此面板将在 Nibbo 后续版本中加入，规划见 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主题",
      themeSubtitle: "为 Nibbo 选择一个主题。卡片会显示内建和能力角标，切换前就能看出 tracked / static / mini 等差异。",
      themeEmpty: "没有可用的主题。",
      ...
      themeImportUserThemeZip: "导入 Nibbo 主题包（.zip）",
      themeImportUserThemeZipHint: "Nibbo 主题 zip：根目录或一个顶层文件夹内必须包含 theme.json；素材放在 assets/，可使用 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 包请用上方入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已刷新：新增 ${imported}，更新 ${updated}，未变 ${unchanged}，移除 ${removed}${invalid ? `，无效 ${invalid}` : ""}${switched ? "；当前主题已回退到 Nibbo" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已卸载 "${name}"${switched ? "，并切回 Nibbo" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `卸载导入宠物失败：${message}`,
      animMapTitle: "动画映射",
      animMapSubtitle: "关掉不想看的打扰动画。事件照样会触发——Nibbo 只是不再播放对应的动画和音效。",
      ...
      aboutFooter: "Nibbo 是开源项目 · 与社区一起打造。",
      aboutCleanupButton: "移除 Nibbo 集成…",
      aboutCleanupConfirm: "要移除本机各 agent 里的 Nibbo hooks / plugins，并在 Nibbo 里禁用所有 agent 集成吗？不会删除 agent 应用或用户配置。",
      aboutCleanupRunning: "正在移除集成…",
      aboutCleanupSuccess: "已从 {affected} 个集成移除 {removed} 项，失败 {failed} 项。",
      aboutCleanupFailed: "集成清理失败",
      aboutCleanupKiroNote: "Kiro 的 nibbo.json 已保留，只移除了 hook 条目。",
      mobileTitle: "移动端 / PWA",
    ...
    "zh-TW": {
      settingsTitle: "設定",
      settingsSubtitle: "設定 Nibbo 在桌面上怎麼動作。",
      sidebarGeneral: "一般",
      sidebarAgents: "Agent 管理",
      sidebarTheme: "主題",
      sidebarAnimMap: "動畫對應",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "到 [@BotFather](https://t.me/botfather) 用 /newbot 建立機器人，把 token 貼在這裡。Token 儲存在 userData env 檔，不會寫入 nibbo-prefs.json。",
      ...
      telegramApprovalRecipientHintHtml: "到 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私訊 /start 取得你的數字 ID。Nibbo 會用它同時做為唯一核准者與接收核准卡片的 chat。記得先到你自己的機器人發一次 /start 啟動私訊。",
      telegramApprovalRecipientPlaceholder: "例如：123456789",
      ...
      telegramApprovalDirectSendDesc: "回覆 Nibbo 完成通知時，聚焦對應的本機終端並貼上單行文字。不會按 Enter。",
      ...
      remoteSshSubtitle: "管理一鍵 SSH 通道，讓遠端 AI 程式設計工作階段像在本機一樣順手。Nibbo 不會留下任何密碼或私鑰通行片語——靠你已經設好的 ssh-agent 或 SSH 金鑰。",
      ...
      remoteSshErrNoLocalPort: "本機 Nibbo 服務尚未啟動。",
      remoteSshErrUnknownStrikes: "連續多次無法識別錯誤，請檢查設定和記錄檔。",
      remoteSshProbeLocalUnhealthy: "通道已建立，但本機 Nibbo 服務狀態異常。",
      remoteSshProbeUnresponsive: "通道已建立，但 Nibbo 沒有回應，請確認 Nibbo 是否正在執行。",
      ...
      remoteSshHooksDeployedAgoDay: "{n} 天前部署",
      remoteSshConnectWarnNoDeploy: "Hook 檔案還沒部署。Connect 只接 SSH 通道、不會部署 hook——要先點 Deploy / Repair Hooks，Nibbo 才會回應遠端工作階段。",
      ...
      doctorPrivacy: "隱私權聲明：診斷報告只在本機產生，Nibbo 不會上傳任何資料。複製前會自動把使用者路徑和金鑰遮起來。",
      ...
      doctorFixConfirmCodex: "Nibbo 會把 Codex 設定裡的 [features].hooks 改成 true。要繼續嗎？",
      doctorFixConfirmCodexTitle: "啟用 Codex hooks？",
      doctorFixConfirmCodexDetail: "這次修復會更動你的 Codex 設定，把 [features].hooks 改成 true。除非你在這裡確認，否則 Nibbo 不會更動。",
      doctorFixConfirmCodexAction: "啟用並修復",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重新啟動 Nibbo",
      doctorRestarting: "重新啟動中",
      doctorRestartConfirmTitle: "重新啟動 Nibbo？",
      doctorRestartConfirmDetail: "Nibbo 會關掉再開起來。AI coding agent 還在跑的請求會被中斷。重新啟動時 Doctor 視窗也會一起關掉。",
      ...
      hardwareBuddyQuickCommandsDesc: "顯示本機 preset 按鈕，只建立由 adapter 處理的 quick_command 事件；Nibbo 不貼上文字，也不執行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      rowAgentPermissionsDesc: "關掉以後，這個 agent 會改由自己的終端機處理提示，不會再彈 Nibbo 對話框。",
      rowCodexPermissionMode: "Codex 權限模式",
      rowCodexPermissionModeDesc: "Native 維持 Codex AutoReview 和終端機原本的提示；Intercept 改成顯示 Nibbo 的允許或拒絕對話框。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      rowSoundDesc: "Nibbo 完成任務或要等輸入時會播放提示聲。",
      rowVolume: "音量",
      rowVolumeDesc: "調整音效音量。停用音效後無法使用。",
      rowLowPowerIdleMode: "低耗電閒置狀態",
      rowLowPowerIdleModeDesc: "Nibbo 不動幾秒後就暫停閒置狀態 SVG 動畫；有活動時立即恢復。",
      ...
      rowSessionCleanupGroupDesc: "Nibbo 等多久才清掉沒動靜的工作階段。主要影響遠端 SSH 工作階段（看不到終端機）——遠端長任務可以放寬；設成 0 就完全不按時間清。",
      ...
      rowOpenAtLoginDesc: "登入系統時自動啟動 Nibbo。",
      ...
      claudeHooksDisconnectConfirmDetail: "這會從 `~/.claude/settings.json` 移除 Nibbo 管的 Claude hooks，並關掉自動管理。「隨 Claude Code 啟動」的偏好會保留，方便之後再開啟。",
      claudeHooksDisconnectConfirmAction: "中斷 hooks 連線",
      claudeHooksDisconnectConfirmKeep: "繼續保留",
      rowStartWithClaude: "隨 Claude Code 啟動",
      rowStartWithClaudeDesc: "Claude Code 工作階段一開始就自動把 Nibbo 叫起來。",
      rowStartWithClaudeDisabledDesc: "要先開啟 Claude hooks 自動管理。關掉的時候，連接埠變動和外部更動都不會自動修。",
      rowHideBubbles: "隱藏對話框",
      rowHideBubblesDesc: "隱藏 Nibbo 的權限、通知和更新對話框。",
      rowBubbleFollow: "對話框跟著 Nibbo",
      ...
      updateBubbleDisableConfirmDetail: "隱藏後可能會錯過更新失敗原因、下載完成提示和重新啟動安裝提示。更新流程本身還是會繼續，只是 Nibbo 不再顯示更新對話框。",
      ...
      placeholderDesc: "這個面板會在 Nibbo 後續版本加入，規劃見 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主題",
      themeSubtitle: "幫 Nibbo 選擇主題。主題卡會顯示是否為內建主題，以及游標跟隨、靜態、迷你模式等支援項目，方便切換前比較差異。",
      themeEmpty: "沒有主題可以用。",
      ...
      themeImportUserThemeZip: "匯入 Nibbo 主題套件（.zip）",
      themeImportUserThemeZipHint: "Nibbo 主題 zip：根目錄或單一頂層資料夾裡要有 theme.json；素材放在 assets/，支援 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 套件請改用上面的入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已重新整理：新增 ${imported}，更新 ${updated}，沒變 ${unchanged}，移除 ${removed}${invalid ? `，無效 ${invalid}` : ""}${switched ? "；目前主題已切回 Nibbo" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已解除安裝「${name}」${switched ? "，並切回 Nibbo" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `解除安裝匯入的寵物失敗：${message}`,
      animMapTitle: "動畫對應",
      animMapSubtitle: "關掉不想看的打擾動畫。事件還是會觸發——Nibbo 只是不再播對應的動畫和音效。",
      ...
      aboutFooter: "Nibbo 是開源專案 · 和社群一起做出來的。",
      aboutCleanupButton: "移除 Nibbo 整合…",
      aboutCleanupConfirm: "要移除本機各 agent 內的 Nibbo hooks / plugins，並在 Nibbo 中停用所有 agent 整合嗎？不會刪除 agent 應用程式或使用者設定。",
      aboutCleanupRunning: "正在移除整合…",
      aboutCleanupSuccess: "已從 {affected} 個整合移除 {removed} 項，失敗 {failed} 項。",
      aboutCleanupFailed: "整合清理失敗",
      aboutCleanupKiroNote: "Kiro 的 nibbo.json 已保留，只移除了 hook 條目。",
      mobileTitle: "行動端 / PWA",
    ...
    ko: {
      settingsTitle: "설정",
      settingsSubtitle: "데스크톱에서 Nibbo의 동작 방식을 설정합니다.",
      sidebarGeneral: "일반",
      sidebarAgents: "에이전트",
      sidebarTheme: "테마",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "[@BotFather](https://t.me/botfather)에서 /newbot으로 bot을 만들고 token을 여기에 붙여넣으세요. userData env 파일에 저장되며 nibbo-prefs.json에는 저장되지 않습니다.",
      ...
      telegramApprovalRecipientHintHtml: "Telegram에서 [@userinfobot](https://t.me/userinfobot)에게 /start를 보내 숫자 ID를 받으세요. Nibbo는 이 ID를 승인 가능한 유일한 사용자이자 승인 카드 수신 chat으로 사용합니다. 본인의 bot에게도 먼저 /start를 한 번 보내 비공개 채팅을 활성화해야 합니다.",
      ...
      telegramApprovalDirectSend: "Direct Send (paste-only)",
      telegramApprovalDirectSendDesc: "Nibbo 완료 알림에 답장하면 해당 로컬 터미널을 포커스하고 한 줄 텍스트를 붙여넣습니다. Enter는 누르지 않습니다.",
      ...
      remoteSshSubtitle: "원클릭 SSH 터널을 관리해 원격 AI 코딩 세션을 매끄럽게 사용하세요. Nibbo는 비밀번호나 패스프레이즈를 저장하지 않으며, 기존 ssh-agent / SSH 키를 사용합니다.",
      ...
      remoteSshErrNoLocalPort: "로컬 Nibbo 서버가 아직 시작되지 않았습니다.",
      remoteSshErrUnknownStrikes: "인식할 수 없는 오류가 연속 발생했습니다. 프로필과 로그를 확인하세요.",
      remoteSshProbeLocalUnhealthy: "터널은 연결되었지만 로컬 Nibbo 서버가 비정상입니다.",
      remoteSshProbeUnresponsive: "터널은 연결되었지만 Nibbo가 응답하지 않습니다. Nibbo가 실행 중인지 확인하세요.",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 파일이 아직 배포되지 않았습니다. Connect는 SSH 터널만 구축하므로, Deploy / Repair Hooks를 눌러야 원격 세션에 Nibbo가 반응합니다.",
      ...
      doctorPrivacy: "개인정보 안내: 진단 보고서는 로컬에서 생성됩니다. Nibbo는 데이터를 업로드하지 않으며 복사 전에 사용자 경로와 비밀값을 가립니다.",
      ...
      doctorFixConfirmCodex: "Nibbo가 Codex 설정의 [features].hooks를 true로 변경합니다. 계속할까요?",
      doctorFixConfirmCodexTitle: "Codex hooks를 켤까요?",
      doctorFixConfirmCodexDetail: "이 복구는 Codex 설정의 [features].hooks를 true로 변경합니다. 여기에서 확인하기 전에는 Nibbo가 이 변경을 하지 않습니다.",
      doctorFixConfirmCodexAction: "켜고 복구",
      doctorFixConfirmCancel: "취소",
      doctorRestartButton: "Nibbo 재시작",
      doctorRestarting: "재시작 중",
      doctorRestartConfirmTitle: "Nibbo를 재시작할까요?",
      doctorRestartConfirmDetail: "Nibbo가 종료된 뒤 다시 실행됩니다. 진행 중인 AI 코딩 에이전트 요청은 중단됩니다. 재시작 중에는 Doctor 창도 함께 닫힙니다.",
      ...
      hardwareBuddyQuickCommandsDesc: "로컬 preset 버튼을 표시해 adapter가 처리하는 quick_command 이벤트만 만듭니다. Nibbo는 텍스트를 붙여넣거나 shell을 실행하지 않습니다.",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      rowAgentPermissionsDesc: "끄면 이 에이전트는 Nibbo 말풍선 대신 자체 터미널에서 프롬프트를 처리합니다.",
      rowCodexPermissionMode: "Codex 권한 모드",
      rowCodexPermissionModeDesc: "Native는 Codex AutoReview와 터미널 프롬프트를 그대로 사용합니다. Intercept는 Nibbo 허용/거부 말풍선을 표시합니다.",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "Nibbo가 작업을 마치거나 입력을 요청할 때 알림음을 재생합니다.",
      rowVolume: "볼륨",
      rowVolumeDesc: "효과음 볼륨을 조절합니다. 효과음이 꺼져 있을 때는 비활성화됩니다.",
      rowLowPowerIdleMode: "저전력 idle",
      rowLowPowerIdleModeDesc: "Nibbo가 몇 초 동안 가만히 있으면 idle SVG 애니메이션을 일시 중지하고, 활동이 있으면 즉시 다시 재생합니다.",
      ...
      rowSessionCleanupGroupDesc: "Nibbo가 비활성 세션을 얼마나 기다린 뒤 정리할지 설정합니다. 주로 터미널이 보이지 않는 원격 SSH 세션에 적용됩니다 — 장시간 원격 작업은 한도를 늘리거나, 세션 타임아웃을 0으로 두면 시간으로는 정리하지 않습니다.",
      ...
      rowOpenAtLoginDesc: "로그인할 때 Nibbo를 자동으로 시작합니다.",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json`에서 Nibbo가 관리하는 Claude hooks를 제거하고 자동 관리를 끕니다. `Claude Code와 함께 시작` 설정은 나중에 다시 켤 수 있도록 유지됩니다.",
      ...
      rowStartWithClaudeDesc: "Claude Code 세션이 시작될 때마다 Nibbo를 자동으로 실행합니다.",
      ...
      rowHideBubblesDesc: "Nibbo의 권한, 알림, 업데이트 말풍선을 숨깁니다.",
      rowBubbleFollow: "말풍선이 Nibbo를 따라다님",
      ...
      updateBubbleDisableConfirmDetail: "업데이트 실패 원인, 다운로드 완료 메시지, 재시작 안내를 놓칠 수 있습니다. 업데이트 흐름은 계속 실행되지만 Nibbo는 업데이트 말풍선을 표시하지 않습니다.",
      ...
      placeholderDesc: "이 패널은 향후 Nibbo 릴리스에 추가됩니다. 계획은 docs/plans/plan-settings-panel.md에 있습니다.",
      ...
      langJapanese: "日本語",
      themeTitle: "테마",
      themeSubtitle: "Nibbo의 테마를 선택합니다. 카드에는 기본 제공/능력 배지가 표시되어 tracked/static/mini 차이를 미리 볼 수 있습니다.",
      ...
      themeImportUserThemeZip: "Nibbo 테마 패키지 가져오기 (.zip)",
      themeImportUserThemeZipHint: "Nibbo 테마 zip: 루트 또는 하나의 최상위 폴더에 theme.json이 있어야 합니다. SVG, GIF, APNG, PNG, WebP, JPG, JPEG 파일은 assets/에 넣으세요. Codex Pet 패키지는 위의 가져오기를 사용하세요.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet을 새로고침했습니다: 신규 ${imported}, 업데이트 ${updated}, 변경 없음 ${unchanged}, 제거 ${removed}${invalid ? `, 무효 ${invalid}` : ""}${switched ? "; 활성 테마를 Nibbo로 되돌림" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}"을(를) 제거했습니다${switched ? " (Nibbo로 전환됨)" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `가져온 펫을 제거하지 못했습니다: ${message}`,
      animMapTitle: "애니메이션 맵",
      animMapSubtitle: "개별 인터럽트 애니메이션을 끕니다. 이벤트는 계속 발생하지만 Nibbo는 선택한 상태의 화면과 소리만 건너뜁니다.",
      ...
      aboutFooter: "Nibbo는 오픈 소스 · 커뮤니티와 함께 만듭니다.",
      aboutCleanupButton: "Nibbo 통합 제거…",
      aboutCleanupConfirm: "로컬 에이전트의 Nibbo hooks/plugins를 제거하고 Nibbo의 모든 에이전트 통합을 비활성화할까요? 에이전트 앱이나 사용자 설정은 삭제하지 않습니다.",
      ...
      aboutCleanupKiroNote: "Kiro nibbo.json은 유지하고 hook 항목만 제거했습니다.",
      mobileTitle: "모바일 / PWA",
    ...
    ja: {
      settingsTitle: "設定",
      settingsSubtitle: "Nibbo のデスクトップでの動作を設定します。",
      sidebarGeneral: "一般",
      ...
      telegramApprovalStep1Title: "1. Bot Token",
      telegramApprovalBotToken: "Bot token",
      telegramApprovalBotTokenHintHtml: "[@BotFather](https://t.me/botfather) で /newbot を使って bot を作り、token をここに貼り付けます。token は userData env ファイルに保存され、nibbo-prefs.json には保存されません。",
      ...
      telegramApprovalRecipientHintHtml: "Telegram で [@userinfobot](https://t.me/userinfobot) に /start を送って数値 ID を取得します。Nibbo はこの ID を唯一の承認者と承認カードを送る chat の両方として使います。事前に自分の bot にも /start を一度送ってプライベートチャットを有効にしてください。",
      ...
      telegramApprovalDirectSendDesc: "Nibbo の完了通知に返信すると、対応するローカル端末をフォーカスして 1 行のテキストを貼り付けます。Enter は送信しません。",
      ...
      remoteSshSubtitle: "ワンクリック SSH トンネルを管理し、リモートの AI コーディングセッションをローカルのように扱えます。Nibbo はパスワードやパスフレーズを保存せず、既存の ssh-agent / SSH キーを使います。",
      ...
      remoteSshErrNoLocalPort: "ローカル Nibbo サーバーがまだ起動していません。",
      remoteSshErrUnknownStrikes: "認識できないエラーが連続して発生しました。プロフィールとログを確認してください。",
      remoteSshProbeLocalUnhealthy: "トンネルは確立しましたがローカル Nibbo サーバーが異常です。",
      remoteSshProbeUnresponsive: "トンネルは確立しましたが Nibbo が応答しません。Nibbo が起動しているか確認してください。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook ファイルがまだデプロイされていません。Connect は SSH トンネルを張るだけなので、Deploy / Repair Hooks を押さないとリモートセッションに Nibbo が反応しません。",
      ...
      doctorPrivacy: "プライバシー: この診断レポートはローカルで生成されます。Nibbo はデータをアップロードしません。コピー前にユーザーパスと秘密情報はマスクされます。",
      ...
      doctorFixConfirmCodex: "Nibbo が Codex 設定の [features].hooks を true にします。続行しますか？",
      doctorFixConfirmCodexTitle: "Codex hooks を有効にしますか？",
      doctorFixConfirmCodexDetail: "この修復は Codex 設定を変更し、[features].hooks を true にします。ここで確認するまで、Nibbo はこの変更を行いません。",
      doctorFixConfirmCodexAction: "有効化して修復",
      doctorFixConfirmCancel: "キャンセル",
      doctorRestartButton: "Nibbo を再起動",
      doctorRestarting: "再起動中",
      doctorRestartConfirmTitle: "Nibbo を再起動しますか？",
      doctorRestartConfirmDetail: "Nibbo を終了して再起動します。進行中の AI coding agent リクエストは切断されます。再起動中は Doctor ウィンドウも閉じます。",
      ...
      hardwareBuddyQuickCommandsDesc: "ローカル preset ボタンを表示し、adapter が処理する quick_command イベントだけを作成します。Nibbo は貼り付けや shell 実行をしません。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      rowAgentPermissionsDesc: "オフにすると、このエージェントは Nibbo の吹き出しではなく自身のターミナル上でプロンプトを処理します。",
      rowCodexPermissionMode: "Codex 権限モード",
      rowCodexPermissionModeDesc: "Native は Codex AutoReview とターミナルの標準プロンプトに任せます。Intercept は Nibbo の許可/拒否吹き出しを表示します。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      rowSoundDesc: "Nibbo がタスクを完了したとき、または入力を求めたときに音を再生します。",
      rowVolume: "音量",
      rowVolumeDesc: "効果音の音量を調整します。効果音オフの時は無効になります。",
      rowLowPowerIdleMode: "省電力アイドル",
      rowLowPowerIdleModeDesc: "数秒間 Nibbo が静止していたら idle SVG アニメーションを停止し、活動が再開すると即座に復帰します。",
      ...
      rowSessionCleanupGroupDesc: "Nibbo が非アクティブなセッションを整理するまでの待機時間。主にターミナルが見えないリモート SSH セッションに影響します — 長時間のリモート作業では制限を緩めるか、セッションタイムアウトを 0 にすると時間では整理しません。",
      ...
      rowOpenAtLoginDesc: "ログイン時に Nibbo を自動起動します。",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json` から Nibbo 管理の Claude hooks を削除し、自動管理をオフにします。`Claude Code と同時に起動` 設定は後で再有効化できるよう保持されます。",
      claudeHooksDisconnectConfirmAction: "hooks を切断",
      claudeHooksDisconnectConfirmKeep: "接続を維持",
      rowStartWithClaude: "Claude Code と同時に起動",
      rowStartWithClaudeDesc: "Claude Code セッションが開始するたびに Nibbo を自動起動します。",
      rowStartWithClaudeDisabledDesc: "Claude hooks の自動管理が必要です。管理がオフの間はポート変更や設定上書きが自動修復されません。",
      rowHideBubbles: "吹き出しを非表示",
      rowHideBubblesDesc: "Nibbo の権限・通知・アップデート吹き出しをまとめて非表示にします。",
      rowBubbleFollow: "吹き出しが Nibbo に追従",
      ...
      updateBubbleDisableConfirmDetail: "アップデートエラーの原因・ダウンロード完了通知・再起動プロンプトを見逃す可能性があります。アップデート処理自体は継続しますが、Nibbo は吹き出しを表示しません。",
      ...
      placeholderDesc: "このパネルは Nibbo の今後のリリースで追加されます。計画は docs/plans/plan-settings-panel.md にあります。",
      ...
      langJapanese: "日本語",
      themeTitle: "テーマ",
      themeSubtitle: "Nibbo のテーマを選びます。カードには組み込み・能力バッジが表示されるので、tracked / static / mini の違いを切替前に確認できます。",
      ...
      themeImportUserThemeZip: "Nibbo テーマパッケージをインポート（.zip）",
      themeImportUserThemeZipHint: "Nibbo テーマ zip: ルートまたは 1 つのトップフォルダに theme.json が必要です。SVG、GIF、APNG、PNG、WebP、JPG、JPEG は assets/ に入れてください。Codex Pet パッケージは上の入口を使います。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet を更新しました: 新規 ${imported}、更新 ${updated}、変更なし ${unchanged}、削除 ${removed}${invalid ? `、無効 ${invalid}` : ""}${switched ? "、使用中テーマを Nibbo に戻しました" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}" をアンインストールしました${switched ? "。Nibbo に戻しました" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `インポート済みペットをアンインストールできませんでした: ${message}`,
      animMapTitle: "アニメーションマップ",
      animMapSubtitle: "個別の割り込みアニメーションをオフにできます。イベント自体は発火しますが、Nibbo は選択した状態の表示と効果音をスキップします。",
      ...
      aboutFooter: "Nibbo はオープンソース。コミュニティと一緒に作っています。",
      aboutCleanupButton: "Nibbo 連携を削除…",
      aboutCleanupConfirm: "ローカル agent から Nibbo hooks/plugins を削除し、Nibbo のすべての agent 連携を無効にしますか？agent アプリやユーザー設定は削除しません。",
      ...
      aboutCleanupKiroNote: "Kiro の nibbo.json は保持し、hook 項目だけを削除しました。",
