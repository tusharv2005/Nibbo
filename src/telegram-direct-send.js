...
public class NibboPasteKeys {
    [DllImport("user32.dll")] public static extern void keybd_event(byte bVk, byte bScan, uint dwFlags, UIntPtr dwExtraInfo);
}
"@
[NibboPasteKeys]::keybd_event(0x11, 0, 0, [UIntPtr]::Zero)
[NibboPasteKeys]::keybd_event(0x56, 0, 0, [UIntPtr]::Zero)
[NibboPasteKeys]::keybd_event(0x56, 0, 2, [UIntPtr]::Zero)
[NibboPasteKeys]::keybd_event(0x11, 0, 2, [UIntPtr]::Zero)
`;
}
...
function createTelegramDirectSend({
  ...
  async function handleTextMessage(payload = {}) {
    ...
    if (!promptText) {
      return {
        status: "empty",
        text: "Send text as a reply to a Nibbo completion notification.",
      };
    }
    ...
    if (!mapping) {
      ...
      return {
        ...
        text: "Reply to a Nibbo completion notification to choose the session.",
      };
    }
