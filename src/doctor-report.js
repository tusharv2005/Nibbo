...
function formatDiagnosticReport(result, meta = {}) {
  ...
  const lines = [
    "# Nibbo Diagnostic Report",
    "",
    `- Generated: ${generatedAt}`,
    `- Nibbo version: ${version}`,
  ...
  lines.push(
    "",
    "**Privacy notice**: This report is generated locally. Nibbo does not upload any data. User paths are replaced with `~`, and Nibbo app paths are replaced with `[APP]`. The report contains no API keys, tokens, conversation content, or document filenames."
  );
