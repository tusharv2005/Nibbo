...
Create `<copilot-home>/hooks/hooks.json` and replace `/path/to/nibbo` with your actual install path:

```json
{
  "version": 1,
  "hooks": {
    "sessionStart":         [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js sessionStart",         "powershell": "node /path/to/nibbo/hooks/copilot-hook.js sessionStart",         "timeoutSec": 5 }],
    "userPromptSubmitted":  [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js userPromptSubmitted",  "powershell": "node /path/to/nibbo/hooks/copilot-hook.js userPromptSubmitted",  "timeoutSec": 5 }],
    "preToolUse":           [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js preToolUse",           "powershell": "node /path/to/nibbo/hooks/copilot-hook.js preToolUse",           "timeoutSec": 5 }],
    "postToolUse":          [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js postToolUse",          "powershell": "node /path/to/nibbo/hooks/copilot-hook.js postToolUse",          "timeoutSec": 5 }],
    "sessionEnd":           [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js sessionEnd",           "powershell": "node /path/to/nibbo/hooks/copilot-hook.js sessionEnd",           "timeoutSec": 5 }],
    "errorOccurred":        [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js errorOccurred",        "powershell": "node /path/to/nibbo/hooks/copilot-hook.js errorOccurred",        "timeoutSec": 5 }],
    "agentStop":            [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js agentStop",            "powershell": "node /path/to/nibbo/hooks/copilot-hook.js agentStop",            "timeoutSec": 5 }],
    "subagentStart":        [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js subagentStart",        "powershell": "node /path/to/nibbo/hooks/copilot-hook.js subagentStart",        "timeoutSec": 5 }],
    "subagentStop":         [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js subagentStop",         "powershell": "node /path/to/nibbo/hooks/copilot-hook.js subagentStop",         "timeoutSec": 5 }],
    "preCompact":           [{ "type": "command", "bash": "node /path/to/nibbo/hooks/copilot-hook.js preCompact",           "powershell": "node /path/to/nibbo/hooks/copilot-hook.js preCompact",           "timeoutSec": 5 }]
  }
}
```
...
- **macOS / Linux GUI launches**: Clawd.app launched by launchd / Finder **does not inherit** env vars from your shell's `.zshrc` / `.bashrc`. To make `COPILOT_HOME` visible to Nibbo:
