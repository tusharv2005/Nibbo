...
3. Put the theme folder in your Clawd user themes directory:
   - Windows: `%APPDATA%/nibbo/themes/pixel-cat/`
   - macOS: `~/Library/Application Support/nibbo/themes/pixel-cat/`
   - Linux: `~/.config/nibbo/themes/pixel-cat/`
...
1. Scaffold a theme:
   ...
   - Windows: `%APPDATA%/nibbo/themes/my-theme/`
   - macOS: `~/Library/Application Support/nibbo/themes/my-theme/`
   - Linux: `~/.config/nibbo/themes/my-theme/`
...
6. (Optional) Validate:
   ```bash
   node scripts/validate-theme.js ~/.config/nibbo/themes/my-theme
   ```
...
2. Users extract to `{userData}/themes/`
   - Windows: `%APPDATA%/nibbo/themes/`
   - macOS: `~/Library/Application Support/nibbo/themes/`
   - Linux: `~/.config/nibbo/themes/`
